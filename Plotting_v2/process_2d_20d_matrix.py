...
min_age = np.arange(10 * 24, 0 * 24, -10 * 24).astype(int) # hours
min_tmp = 0 # C
...
mn_index = 12 # change for differnt month start
ref = dt.datetime(1960, 1, 1)
for i in range(334, len(file_names)):
  now = dt.datetime.now()
...
#  if i == 1:
    ...
    np.savez(out_dir + '/connect_2d_20d_' + 
