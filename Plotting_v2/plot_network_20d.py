...
fnames = sorted(glob.glob(out_dir + 'connect_2d_20d_' + yr + '*.npz'))
print(fnames)
...
fig1.savefig('./Figures/network_graph_' + yr + '_20d.png', dpi=300)
if summer:
  fig2.savefig('./Figures/between_' + yr + '_JAS' + '_' + str(thresh) + '_20d.png', dpi=300)
else:
  fig2.savefig('./Figures/between_' + yr + '_' + str(thresh) + '_20d.png', dpi=300)
